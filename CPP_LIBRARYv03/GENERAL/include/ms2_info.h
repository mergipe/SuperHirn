...
public:
  ...
  string get_AC(){return AC.begin()->first;};
  map<string, double> get_ALL_AC(){return AC;};
  map<string, double>* getACListRefr(){return &AC;};
  map<string, double>::iterator get_ALL_AC_START(){return AC.begin();};
  map<string, double>::iterator get_ALL_AC_END(){return AC.end();};
  bool find_AC( string );
  void set_AC(string);
  void set_AC(string,double);
  ...
  static double getMolecularAminoAcidMass( char );
