...
private:
  ...
  // mzXML parameters
  int total_scan;  
  map<int, pair<int, double> > previousMSnScans;
...
public:
  ...
  void processMS1InputData( Generic_MS_Scan* );
  ...
  // - centoid them
  // - add them to Process_Data Structure:
  void processMS2InputData( Generic_MS_Scan* );
  ...
  void findMS1PrecursorData(  Generic_MS_Scan* );
