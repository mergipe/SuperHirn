...
protected:
  ...
  // vector containin the performed MS/MS scans:
  vector<double> childScans;
...
public:
  ...
  ///////////
  // accessing the child MS/MS scans:
  void setChildScan(double scan){ childScans.push_back( scan );};
  vector<double> getChildScans(){ return childScans;};
