...
public class LCMS implements Cloneable, Serializable {
	 ...
	 * 
	 * @param iName name of the LCMS run
	 * 
	 * @param iID identifier of the LCM run
	 */
	 ...
	 * 
	 * @param id identifier of the searched MS1 feature
	 */
