...
public class Manager {
	...
	private void write(MS1Feature iFeature) {
		try {
			...
			String query = "INSERT INTO "
					...
					+ "mzXML_Name, signalToNoise, featureID) VALUES (";
			...
			query = query + ",";
			query = query + "'" + iFeature.mzXMLName() + "'" + ","
					+ iFeature.signalToNoise() + "," + iFeature.id();
			query = query + ")";
			this.rdsAccess.performSQLStatement(query);

			this.writeMS2(iFeature);
	...
	private void writeMS2(MS1Feature iFeature) {
		try {
			...
			if (peps != null) {
				...
				statement = statement
						+ " ( mzXML_Name, fkMS1FeatureID, scan_number) VALUES(";
