...
public:
  ...
  */
  ...
  ///////////////////////////////////////////
  // child MS/MS scans:
  void addChildMSMSScans( double scan ){childMSMSScans.push_back(scan);};
  void addChildMSMSScans( vector<double> scans ){childMSMSScans = scans;};
  vector<double>::iterator getChildMSMSScanSTART( ){return childMSMSScans.begin();};
  vector<double>::iterator getChildMSMSScanEND( ){return childMSMSScans.end();};
