...
@implementation OverviewItemView
...
- (id)initWithFrame:(CGRect)frame {
    if ((self = [super initWithFrame:frame])) {
		...
		//UIFont *textFont = [iCompetenceEnvironment textFont];
		...
		//issueLabel.font = [iCompetenceEnvironment textFont];
		...
		//titleLabel.font = [iCompetenceEnvironment textFont];
		...
		//subTitleLabel.font = [iCompetenceEnvironment subtitleFont];
