...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil 
{
	...
	{
		bottomNavViewController = [[ModuleBottomNavController alloc] initWithNibName:@"ModuleBottomNavController" bundle:nil];
...
-(void)addSwipeItem:(UIView*)iView:(NSString*) iconPath: (int)i
{
