...
class SuperHirn_manager{
    ...
    private:
        ...
        /////////////////////////////////////////////////////////////////////
        // returns the basename of a file without its extension, given the
        // filepath
        string get_file_basename(string filepath);

        ////////////////////////////////////////////////
        // pop the reference run based on its filename
        LC_MS* pop_reference_run(vector<LC_MS>* runs, string filename);

        ////////////////////////////////////////////////////////////////////////
        // write aligned runs in XML files
        void write_aligned_runs(vector<LC_MS>* runs, LC_MS* ref);

        ////////////////////////////////////////////////
        // alignment of LC-MS runs with a reference run
        void start_alignment_with_reference(vector<LC_MS>* runs, LC_MS* ref);
    ...
    public:
        ...
        ////////////////////////////////////////////////
        // alignment of LC-MS runs with a reference run
        void start_alignment_with_reference(string filename);

        ////////////////////////////////////////////////
        // alignment of LC-MS runs with a reference run
        // however, here the first run is choosen to be the reference
        void start_alignment_with_reference();
